...
public class SocialNetworkUserImpl<U extends User> extends UserImpl implements SocialNetworkUser<U> {
	...
	private Map<U, String> followedUsers = new HashMap<>();
	...
	public Collection<U> getFollowedUsersInGroup(final String groupName) {
		Collection<U> group = new LinkedList<>();
		for (U user : followedUsers.keySet()) {
			if (followedUsers.get(user) == groupName) {
				group.add(user);
			}
		}
		return group;
	...
	public List<U> getFollowedUsers() {
		return new LinkedList<U>(followedUsers.keySet());
	}
